...
% Alternatively compile with: pdflatex
%
% This template is compatible with both LuaLaTeX and pdfLaTeX:
% - LuaLaTeX: Uses Aptos font (Bauschule CI) with polyglossia for German language support
% - pdfLaTeX: Uses Helvetica as fallback font with babel for German language support
%
\documentclass[
    %answers,
    a4paper,ngerman,12pt, addpoints]{exam}

% Engine detection and conditional package loading
\usepackage{iftex}
...
\ifPDFTeX
    ...
    % Use a font that's similar to Aptos for pdfLaTeX
    \usepackage{helvet} % Helvetica as fallback
    \renewcommand{\familydefault}{\sfdefault}
\else
    % LuaLaTeX/XeLaTeX setup
